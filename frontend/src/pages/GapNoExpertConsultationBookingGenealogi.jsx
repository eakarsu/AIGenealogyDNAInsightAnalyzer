...
// Auto-generated page for: No expert consultation booking (genealogists, genetic counse

export default function GapNoExpertConsultationBookingGenealogi() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-expert-consultation-booking-genealogi', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No expert consultation booking (genealogists, genetic counse</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No expert consultation booking (genealogists, genetic counselors)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No expert consultation booking (genealogists, genetic counse'}
        </button>
      </form>
