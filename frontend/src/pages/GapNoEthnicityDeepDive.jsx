...
// Auto-generated page for: No ethnicity deep-dive

export default function GapNoEthnicityDeepDive() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-ethnicity-deep-dive', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No ethnicity deep-dive</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No ethnicity deep-dive</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No ethnicity deep-dive'}
        </button>
      </form>
