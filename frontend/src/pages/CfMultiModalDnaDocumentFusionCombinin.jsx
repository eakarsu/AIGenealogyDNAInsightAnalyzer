...
// Auto-generated page for: Multi-modal DNA + document fusion combining matches, census,

export default function CfMultiModalDnaDocumentFusionCombinin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-multi-modal-dna-document-fusion-combinin', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Multi-modal DNA + document fusion combining matches, census,</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Multi-modal DNA + document fusion combining matches, census, ship manifests, land deeds into one narrative.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Multi-modal DNA + document fusion combining matches, census,'}
        </button>
      </form>
