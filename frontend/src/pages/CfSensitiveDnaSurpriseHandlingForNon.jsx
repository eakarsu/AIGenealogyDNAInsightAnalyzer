...
// Auto-generated page for: Sensitive DNA-surprise handling for non-paternity/adoption d

export default function CfSensitiveDnaSurpriseHandlingForNon() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-sensitive-dna-surprise-handling-for-non', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Sensitive DNA-surprise handling for non-paternity/adoption d</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Sensitive DNA-surprise handling for non-paternity/adoption detection with counselor referral.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Sensitive DNA-surprise handling for non-paternity/adoption d'}
        </button>
      </form>
