...
// Auto-generated page for: No health-risk-explanation in layman terms

export default function GapNoHealthRiskExplanationInLayman() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-health-risk-explanation-in-layman', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No health-risk-explanation in layman terms</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No health-risk-explanation in layman terms</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No health-risk-explanation in layman terms'}
        </button>
      </form>
