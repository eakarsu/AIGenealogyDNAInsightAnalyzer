...
// Auto-generated page for: No payment / subscription module

export default function GapNoPaymentSubscriptionModule() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-payment-subscription-module', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No payment / subscription module</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No payment / subscription module</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No payment / subscription module'}
        </button>
      </form>
