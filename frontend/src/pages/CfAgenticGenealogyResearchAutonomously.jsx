...
// Auto-generated page for: Agentic genealogy research autonomously scanning Ancestry/Fa

export default function CfAgenticGenealogyResearchAutonomously() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-agentic-genealogy-research-autonomously-', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Agentic genealogy research autonomously scanning Ancestry/Fa</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Agentic genealogy research autonomously scanning Ancestry/FamilySearch/local archives with confidence-scored tree extension.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Agentic genealogy research autonomously scanning Ancestry/Fa'}
        </button>
      </form>
