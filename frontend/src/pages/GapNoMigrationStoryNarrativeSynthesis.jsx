...
// Auto-generated page for: No migration-story-narrative synthesis

export default function GapNoMigrationStoryNarrativeSynthesis() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-migration-story-narrative-synthesis', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No migration-story-narrative synthesis</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No migration-story-narrative synthesis</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No migration-story-narrative synthesis'}
        </button>
      </form>
