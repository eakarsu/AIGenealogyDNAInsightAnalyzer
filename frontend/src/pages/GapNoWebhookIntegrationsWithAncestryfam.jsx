...
// Auto-generated page for: No webhook integrations with Ancestry/FamilySearch APIs

export default function GapNoWebhookIntegrationsWithAncestryfam() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-webhook-integrations-with-ancestryfam', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No webhook integrations with Ancestry/FamilySearch APIs</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No webhook integrations with Ancestry/FamilySearch APIs</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No webhook integrations with Ancestry/FamilySearch APIs'}
        </button>
      </form>
