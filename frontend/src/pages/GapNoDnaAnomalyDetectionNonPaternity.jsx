...
// Auto-generated page for: No DNA anomaly detection (non-paternity, sample quality)

export default function GapNoDnaAnomalyDetectionNonPaternity() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-dna-anomaly-detection-non-paternity', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No DNA anomaly detection (non-paternity, sample quality)</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No DNA anomaly detection (non-paternity, sample quality)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No DNA anomaly detection (non-paternity, sample quality)'}
        </button>
      </form>
