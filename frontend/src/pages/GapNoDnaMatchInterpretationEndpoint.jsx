...
// Auto-generated page for: No dna-match-interpretation endpoint

export default function GapNoDnaMatchInterpretationEndpoint() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-dna-match-interpretation-endpoint', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No dna-match-interpretation endpoint</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No dna-match-interpretation endpoint</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No dna-match-interpretation endpoint'}
        </button>
      </form>
