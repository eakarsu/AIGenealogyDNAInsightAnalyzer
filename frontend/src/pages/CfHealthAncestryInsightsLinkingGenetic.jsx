...
// Auto-generated page for: Health + ancestry insights linking genetic findings to geogr

export default function CfHealthAncestryInsightsLinkingGenetic() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-health-ancestry-insights-linking-genetic', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Health + ancestry insights linking genetic findings to geogr</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Health + ancestry insights linking genetic findings to geographic populations.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Health + ancestry insights linking genetic findings to geogr'}
        </button>
      </form>
