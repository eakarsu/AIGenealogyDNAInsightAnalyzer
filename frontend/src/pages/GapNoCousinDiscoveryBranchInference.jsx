...
// Auto-generated page for: No cousin-discovery / branch inference

export default function GapNoCousinDiscoveryBranchInference() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-cousin-discovery-branch-inference', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No cousin-discovery / branch inference</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No cousin-discovery / branch inference</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No cousin-discovery / branch inference'}
        </button>
      </form>
