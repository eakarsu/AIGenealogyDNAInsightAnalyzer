# Governed genetic-genealogy insights
...
Active versioned explicit consent, encrypted-key references and source digests for genetic samples, and consent-controlled matches with shared-centimorgan and confidence inputs.

The evaluator rejects revoked consent, insecure provenance, invalid confidence and medical claims, and exposes false-match/population-bias warnings. No genetic provider, reference population, archive, identity, KMS, clinical interpretation, genealogist validation or surprise-disclosure workflow is claimed.
